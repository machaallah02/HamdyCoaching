...
<div class="relative w-full h-screen overflow-hidden flex items-center justify-center">
    ...
    <div class="absolute inset-0 flex flex-col items-center justify-center bg-indigo-400 bg-opacity-50">
        <h3 class="text-white p-4 mt-4 reveal-1">Bonjour</h3>
        <h1 class="text-white text-6xl font-bold p-6 reveal-1">Contact<strong class="text-6xl text-blue-500">.</strong></h1>
        <p class="text-white text-center reveal-2">Contactez-nous pour plus de renseignements sur le coaching pour le business/Dirigeant d'équipe et nos <br> programmes.</p>
        <div class="flex justify-center mt-4">
            <div class="flex flex-col items-center justify-center mx-4">
                ...
                <p class="text-white reveal-3">Entreprise del'Union non loinde la suprette FIDELITAS</p>
            </div>
            <div class="flex flex-col items-center justify-center mx-4">
                <img src="assets/img/tel.png" alt="" class="w-10 h-10 mb-2 bg-white rounded-full p-2">
                <p class="text-white reveal-3">+228 <strong>92 31 60 71</strong></p>
            </div>
        </div>
    </div>
</div>
