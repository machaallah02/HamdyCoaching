        ...
        <ul class="navbar-nav mb-2 mb-lg-0 " style="margin-left: auto">
            <li class="nav-item dropdown" onmouseover="showDropdownMenu()" onmouseout="hideDropdownMenu()">
                ...
                <div class="dropdown-menu" id="coachingDropdown" aria-labelledby="coachingDropdown">
                  <a class="dropdown-item @if (Request::route()->getName() == 'coaching_equipe') active @endif" aria-current="page" href="{{ route('coaching_equipe') }}">Coaching D'équipe</a>
          ...
          <li class="nav-item">
            <a class="nav-link @if (Request::route()->getName()=='app_blog') active @endif" aria-current="page" href="{{ route('app_blog') }}">Blog</a>
          </li>
          <li class="nav-item">
